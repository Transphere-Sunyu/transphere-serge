...
class GenerateConfigurationFile():
    ...
    checkout_path = os.path.join(current_dir,'projects')
    def __init__(self, project_Id, remote_path, branch, task_id, source_dir, checkout_path=checkout_path):
        ...
        self.source_dir = checkout_path+'/'+ project_Id + source_dir
